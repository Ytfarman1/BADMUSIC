...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("BADMUSIC/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("BADMUSIC/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "BADMUSIC/assets/play_icons.png"
    ...
    font = ImageFont.truetype("BADMUSIC/assets/font.ttf", 28)  # 
    text = "YT MUSIC"
